...
void MagneBox::DrawBright()
{
	...
	{
		//S極の場合赤色に光らせる
		color = { 1.f - (m_changeCnt / k_changeMoment),0,m_changeCnt / k_changeMoment };
	}
	else if ((m_maguneForce & MagunePowerS) != 0)
	{
		//N極の場合青色に光らせる
		color = { m_changeCnt / k_changeMoment,0, 1.f - (m_changeCnt / k_changeMoment) };
	}
